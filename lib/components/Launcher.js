  ...
  Launcher.prototype.render = function render() {
    ...
    return _react2.default.createElement(
      ...
      _react2.default.createElement(
        ...
        _react2.default.createElement("i", { className: "icon-close-button sc-open-icon sc-cloud-icon" }),
        _react2.default.createElement("i", { className: "icon-chat-widget-cloud sc-closed-icon sc-close-icon" })
      ),
