...
require("../../public/asssets/css/intro-social-icons.css");
  ...
  Launcher.prototype.render = function render() {
    ...
    return _react2.default.createElement(
      ...
      _react2.default.createElement(
        ...
        _react2.default.createElement("i", { className: "icon-close-button sc-open-icon" }),
        _react2.default.createElement("i", { className: "icon-chat-widget-cloud sc-closed-icon" })
      ),
